  ...
  const daysData: DayRecord[] = [
    { id: 1, day_number: 1, date: '9/24', weekday: '周四', city: '巴勒莫', city_en: 'Palermo', sort_order: 1, content_json: JSON.stringify({
      ...
      locations: [
        ...
        { name: '巴勒莫耶稣堂', nameIt: 'Chiesa del Gesu', hours: '9:00-18:30', cost: '2€', tags: ['景点'], duration: '1h', tips: '现场买门票2€', intro: '西西里巴洛克体系的极致装饰化代表', lat: 38.1112, lng: 13.3597, order: 2 },
        { name: '诺曼王宫&帕拉蒂尼礼拜堂', nameIt: 'Palazzo dei Normanni', hours: '8:30-16:30', cost: '19€', tags: ['景点'], duration: '2h', tips: '先冲2楼礼拜堂错开人流；不得穿着暴露', intro: '拜占庭马赛克+阿拉伯蜂巢天花板+拉丁大理石地面', lat: 38.1100, lng: 13.3545, order: 3 },
        { name: '巴勒莫主教堂', nameIt: 'Cattedrale di Palermo', hours: '7:00-19:00', cost: '免费', tags: ['景点'], duration: '1h', tips: '主殿免费，登顶7€', intro: '阿拉伯-诺曼风格代表作，融合多种建筑元素', lat: 38.1117, lng: 13.3385, order: 4 },
        { name: '马西莫剧院', nameIt: 'Teatro Massimo', cost: '免费', tags: ['景点'], duration: '10min', tips: '外面路过即可，《教父3》终 scene 拍摄地', intro: '意大利最大歌剧院之一，新古典主义建筑', lat: 38.1145, lng: 13.3525, order: 5 },
        ...
        { name: '四角广场', nameIt: 'Quattro Canti', cost: '免费', tags: ['景点'], duration: '30min', intro: '巴洛克风格十字路口，四座喷泉代表四季', lat: 38.1113, lng: 13.3573, order: 7 },
        { name: '普雷托利亚喷泉', nameIt: 'Fontana Pretoria', cost: '免费', tags: ['景点'], duration: '10min', tips: '维修中，外面路过', intro: '16世纪文艺复兴喷泉，被称为"羞耻之泉"', lat: 38.1115, lng: 13.3580, order: 8 },
    ...
    { id: 2, day_number: 2, date: '9/25', weekday: '周五', city: '陶尔米纳', city_en: 'Taormina', sort_order: 2, content_json: JSON.stringify({
      ...
      locations: [{ name: 'Parco Trevelyan', nameIt: 'Parco Trevelyan', hours: '8:00-20:00', cost: '免费', tags: ['景点'], duration: '30min', intro: '俯瞰埃特纳火山和纳克索斯湾', lat: 37.8535, lng: 15.2870, order: 1 }],
    ...
    { id: 3, day_number: 3, date: '9/26', weekday: '周六', city: '陶尔米纳', city_en: 'Taormina', sort_order: 3, content_json: JSON.stringify({
      ...
      locations: [
        { name: '贝拉岛观景平台', nameIt: 'Belvedere di Via Pirandello', hours: '24h', cost: '免费', tags: ['景点'], duration: '1h', intro: '俯瞰Isola Bella爱心小岛的最佳机位', lat: 37.8490, lng: 15.2845, order: 1 },
        { name: '贝拉岛', nameIt: 'Isola Bella', hours: '24h', cost: '免费', tags: ['景点'], duration: '2h', tips: '退潮时去，备好溯溪鞋', intro: '爱心状小岛，退潮时与陆地相连', lat: 37.8478, lng: 15.2855, order: 2 },
      ],
    ...
    { id: 4, day_number: 4, date: '9/27', weekday: '周日', city: '锡拉库萨', city_en: 'Siracusa', sort_order: 4, content_json: JSON.stringify({
      ...
      locations: [
        { name: '阿波罗神庙', nameIt: 'Tempio di Apollo', cost: '免费', tags: ['景点'], duration: '1h', intro: '锡拉库扎最古老的希腊遗迹', lat: 37.0600, lng: 15.2920, order: 1 },
        { name: '锡拉库萨教堂广场', nameIt: 'Piazza del Duomo', cost: '2€', tags: ['景点'], duration: '1h', intro: '奥提伽岛中心，巴洛克建筑群环绕', lat: 37.0590, lng: 15.2925, order: 2 },
        { name: '马尼亚切城堡', nameIt: 'Maniace Castle', cost: '5€', tags: ['景点'], duration: '1h', intro: '腓特烈二世的海边皇家堡垒', lat: 37.0540, lng: 15.2960, order: 3 },
      ],
    ...
    { id: 5, day_number: 5, date: '9/28', weekday: '周一', city: '陶尔米纳', city_en: 'Taormina', sort_order: 5, content_json: JSON.stringify({
      ...
      locations: [
        { name: '古希腊罗马剧场', nameIt: 'Teatro Greco', hours: '8:00-20:00', cost: '17€', tags: ['景点'], duration: '30min', intro: '西西里第二大古剧场', lat: 37.8530, lng: 15.2910, order: 1 },
        { name: '翁贝托一世街', nameIt: 'Corso Umberto', hours: '10:00-21:00', cost: '不定', tags: ['购物'], duration: '2h', intro: '奢侈品、手信、咖啡馆应有尽有', lat: 37.8525, lng: 15.2860, order: 2 },
        { name: '四月九日广场', nameIt: 'Piazza IX Aprile', cost: '不定', tags: ['购物'], duration: '1h', intro: '陶尔米纳市中心', lat: 37.8528, lng: 15.2855, order: 3 },
      ],
    ...
    { id: 6, day_number: 6, date: '9/29', weekday: '周二', city: '索伦托', city_en: 'Sorrento', sort_order: 6, content_json: JSON.stringify({
      ...
      locations: [{ name: '乔瓦娜秘境', nameIt: 'Capo di Sorrento', hours: '24h', cost: '免费', tags: ['景点'], duration: '3h', tips: '带泳衣浴巾和食物', intro: '果冻海秘境，可划船或桨板抵达', lat: 40.6260, lng: 14.3810, order: 1 }],
    ...
    { id: 7, day_number: 7, date: '9/30', weekday: '周三', city: '那不勒斯', city_en: 'Naples', sort_order: 7, content_json: JSON.stringify({
      ...
      locations: [
        { name: '圣塞维诺小堂', nameIt: 'Museo Cappella Sansevero', hours: '预约10:30', cost: '12€', tags: ['景点'], duration: '2h', tips: '先到Ticket Office换纸质票；禁止拍照', intro: '镇馆三杰：《蒙面纱的耶稣》《缠绳的解放者》《贞洁》', lat: 40.8485, lng: 14.2538, order: 1 },
        { name: '圣埃莫堡', nameIt: "Castel Sant'Elmo", hours: '预约17:00', cost: '5€(16:00后2.5€)', tags: ['景点'], duration: '2h', tips: '18:30前必须进城堡；看日落红屋顶', intro: '那不勒斯制高点，俯瞰全城红屋顶与维苏威火山', lat: 40.8440, lng: 14.2400, order: 2 },
    ...
    { id: 8, day_number: 8, date: '10/1', weekday: '周四', city: '庞贝', city_en: 'Pompeii', sort_order: 8, content_json: JSON.stringify({
      ...
      locations: [{ name: '庞贝古城', nameIt: 'Pompeii', hours: '预约10:00', cost: '500 RMB', tags: ['景点'], duration: '4h', intro: '公元79年维苏威火山爆发被掩埋。集合点：Piazza Esedra 4', lat: 40.7508, lng: 14.4870, order: 1 }],
    ...
    { id: 9, day_number: 9, date: '10/2', weekday: '周五', city: '罗马', city_en: 'Roma', sort_order: 9, content_json: JSON.stringify({
      ...
      locations: [
        { name: '那不勒斯主教堂', nameIt: 'Duomo di Napoli', hours: '10:00-17:00 周三闭', cost: '免费', tags: ['景点'], duration: '1h', intro: '圣雅纳略的圣地，每年三次"圣血液化"仪式', lat: 40.8530, lng: 14.2625, order: 1 },
        { name: '圣依纳爵堂', nameIt: 'Piazza S. Ignazio', hours: '9:00-23:30', cost: '免费', tags: ['景点'], duration: '1h', tips: '晚上去看假穹顶天顶画', intro: '透视法在平面画出"假穹顶"', lat: 40.8490, lng: 14.2520, order: 2 },
      ],
    ...
    { id: 10, day_number: 10, date: '10/3', weekday: '周六', city: '梵蒂冈', city_en: 'Vatican', sort_order: 10, content_json: JSON.stringify({
      ...
      tips: { items: [], packingList: [] },
      locations: [
        { name: '圣彼得大教堂', nameIt: "St. Peter's Basilica", hours: '7:00-18:00', cost: '免费(登顶收费)', tags: ['景点'], duration: '2h', tips: '先看《圣殇》、青铜华盖、穹顶', intro: '始建于1506年，历时120年完工', lat: 41.9022, lng: 12.4539, order: 1 },
        { name: '梵蒂冈博物馆', nameIt: 'Vatican Museums', hours: '预约17:30', cost: '免费日(最后周日)', tags: ['景点'], duration: '4h', tips: '禁止穿短裤露肩装；带小镜子拍天顶画', intro: '西斯廷教堂《创世纪》、拉斐尔《雅典学院》、《拉奥孔》', lat: 41.9065, lng: 12.4536, order: 2 },
        { name: '圣天使桥&圣天使堡', nameIt: 'Castel Sant\'Angelo', hours: '24h(桥)', cost: '免费(桥)', tags: ['景点'], duration: '30min', tips: '晚上天黑后去', intro: '台伯河畔地标，桥上有十二天使雕像', lat: 41.9030, lng: 12.4660, order: 3 },
      ],
    ...
    { id: 11, day_number: 11, date: '10/4', weekday: '周日', city: '罗马', city_en: 'Roma', sort_order: 11, content_json: JSON.stringify({
      ...
      tips: { items: [], packingList: [] },
      locations: [
        { name: '万神殿', nameIt: 'Pantheon', hours: '09:00-19:00', cost: '7€', tags: ['景点'], duration: '1h', tips: '八点半排队，排最左边的队', intro: '穹顶直径43.4米，顶部圆洞是唯一光源', lat: 41.8986, lng: 12.4769, order: 1 },
        { name: '特莱维喷泉', nameIt: 'Trevi Fountain', hours: '24h', cost: '2€', tags: ['景点'], duration: '30min', tips: '距万神殿步行600m', intro: '投一枚硬币许下"重返罗马"的愿望', lat: 41.9009, lng: 12.4833, order: 2 },
        { name: '博尔盖塞美术馆', nameIt: 'Galleria Borghese', cost: '免费日(第一个周日)', tags: ['景点'], duration: '2h', intro: '贝尼尼《被劫持的普洛塞庇娜》《阿波罗与达芙妮》', lat: 41.9142, lng: 12.4942, order: 3 },
        { name: '罗马斗兽场', nameIt: 'Colosseum', hours: '8:30-19:15', cost: '通票18€', tags: ['景点'], duration: '3h', tips: '14:00后到，门口领三联票', intro: '建于公元72-80年，曾容纳5-9万观众', lat: 41.8902, lng: 12.4922, order: 4 },
      ],
