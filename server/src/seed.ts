...
export function seedIfNeeded() {
  ...
  const checklist: ChecklistRecord[] = [
    { id: 1, label: '护照', checked: 0, sort_order: 1 },
    { id: 2, label: '现金（欧元）', checked: 0, sort_order: 2 },
    { id: 3, label: '信用卡（Visa/Mastercard）', checked: 0, sort_order: 3 },
    { id: 4, label: '充电宝', checked: 0, sort_order: 4 },
    { id: 5, label: '转换插头', checked: 0, sort_order: 5 },
    { id: 6, label: '雨伞', checked: 0, sort_order: 6 },
    { id: 7, label: '墨镜', checked: 0, sort_order: 7 },
    { id: 8, label: '防晒霜', checked: 0, sort_order: 8 },
    { id: 9, label: '披肩外套', checked: 0, sort_order: 9 },
    { id: 10, label: '相机', checked: 0, sort_order: 10 },
    { id: 11, label: '常用药品', checked: 0, sort_order: 11 },
    { id: 12, label: '洗漱用品', checked: 0, sort_order: 12 },
  ];
