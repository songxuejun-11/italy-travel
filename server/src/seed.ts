  ...
  const daysData: DayRecord[] = [
    { id: 1, day_number: 1, date: '9/24', weekday: '周四', city: '巴勒莫', city_en: 'Palermo', sort_order: 1, content_json: JSON.stringify({
      ...
      locations: [
        ...
        { name: '巴勒莫主教堂', nameIt: 'Cattedrale di Palermo', hours: '7:00-19:00', cost: '免费', tags: ['景点'], duration: '1h', tips: '主殿免费，登顶7€', lat: 38.1117, lng: 13.3385, order: 4 },
        { name: '马西莫剧院', nameIt: 'Teatro Massimo', cost: '免费', tags: ['景点'], duration: '10min', tips: '外面路过即可，《教父3》终 scene 拍摄地', lat: 38.1145, lng: 13.3525, order: 5 },
        ...
        { name: '四角广场', nameIt: 'Quattro Canti', cost: '免费', tags: ['景点'], duration: '30min', lat: 38.1113, lng: 13.3573, order: 7 },
        { name: '普雷托利亚喷泉', nameIt: 'Fontana Pretoria', cost: '免费', tags: ['景点'], duration: '10min', tips: '维修中，外面路过', lat: 38.1115, lng: 13.3580, order: 8 },
    ...
    { id: 3, day_number: 3, date: '9/26', weekday: '周六', city: '陶尔米纳', city_en: 'Taormina', sort_order: 3, content_json: JSON.stringify({
      ...
      locations: [
        ...
        { name: '贝拉岛', nameIt: 'Isola Bella', hours: '24h', cost: '免费', tags: ['景点'], duration: '2h', tips: '退潮时去，备好溯溪鞋', lat: 37.8478, lng: 15.2855, order: 2 },
      ],
    ...
    { id: 4, day_number: 4, date: '9/27', weekday: '周日', city: '锡拉库萨', city_en: 'Siracusa', sort_order: 4, content_json: JSON.stringify({
      ...
      locations: [
        ...
        { name: '锡拉库萨教堂广场', nameIt: 'Piazza del Duomo', cost: '2€', tags: ['景点'], duration: '1h', lat: 37.0590, lng: 15.2925, order: 2 },
    ...
    { id: 6, day_number: 6, date: '9/29', weekday: '周二', city: '索伦托', city_en: 'Sorrento', sort_order: 6, content_json: JSON.stringify({
      ...
      locations: [{ name: '乔瓦娜秘境', nameIt: 'Capo di Sorrento', hours: '24h', cost: '免费', tags: ['景点'], duration: '3h', tips: '带泳衣浴巾和食物', lat: 40.6260, lng: 14.3810, order: 1 }],
    ...
    { id: 7, day_number: 7, date: '9/30', weekday: '周三', city: '那不勒斯', city_en: 'Naples', sort_order: 7, content_json: JSON.stringify({
      ...
      locations: [
        ...
        { name: '圣埃莫堡', nameIt: "Castel Sant'Elmo", hours: '预约17:00', cost: '5€(16:00后2.5€)', tags: ['景点'], duration: '2h', tips: '18:30前必须进城堡；看日落红屋顶', lat: 40.8440, lng: 14.2400, order: 2 },
    ...
    { id: 10, day_number: 10, date: '10/3', weekday: '周六', city: '梵蒂冈', city_en: 'Vatican', sort_order: 10, content_json: JSON.stringify({
      ...
      locations: [
        ...
        { name: '圣天使桥&圣天使堡', nameIt: 'Castel Sant\'Angelo', hours: '24h(桥)', cost: '免费(桥)', tags: ['景点'], duration: '30min', tips: '晚上天黑后去', lat: 41.9030, lng: 12.4660, order: 3 },
      ],
